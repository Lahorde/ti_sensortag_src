...
@set BIM_PATH=..\..\..\util\bim_extflash\cc2640\iar\FlashOnly_ST\Exe

:: Set application name
@set APP_NAME=simple_peripheral_cc2650stk
...
FOR /F "tokens=2 delims=x" %%G IN (config\iar_boundary.bdef) DO (
set STACK_IMG_START=%%G
)
